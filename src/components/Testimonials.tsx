        ...
        <div className="text-center mt-16">
          <div className="glass-morphism p-8 rounded-2xl max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => {
                  const message = encodeURIComponent("Hi! I'm ready to start planning my Kenya safari adventure. Can you help me get started?");
                  window.open(`https://wa.me/+254707608590?text=${message}`, '_blank');
                }}
                className="px-6 py-3 bg-accent hover:bg-accent-glow text-accent-foreground rounded-full font-semibold transition-bounce hover:scale-105"
              >
                📱 Start Planning Now
              </button>
              <button
                onClick={() => {
                  const message = encodeURIComponent("Hi! I'd like to create a custom itinerary for my Kenya trip. Can you help me design the perfect safari experience?");
                  window.open(`https://wa.me/+254707608590?text=${message}`, '_blank');
                }}
                className="px-6 py-3 bg-primary hover:bg-primary-glow text-primary-foreground rounded-full font-semibold transition-bounce hover:scale-105"
              >
                🎯 Custom Itinerary
              </button>
            </div>
