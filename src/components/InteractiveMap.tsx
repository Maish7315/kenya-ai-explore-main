...
import majesticSunset from "@/assets/MAJESTIC SUNSET WITH LION VIEW-BhrCCGOJ.jpeg";
...
const InteractiveMap = () => {
  ...
  const destinations = [
    ...
    },
    {
      ...
      description: 'Narok Oltalet Mall, Second Floor - Visit us for physical bookings',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2">
            <div className="relative bg-gradient-surface rounded-2xl p-8 shadow-elegant" style={{ backgroundImage: `url(${majesticSunset})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          <div className="lg:col-span-1">
            <div className="glass-morphism rounded-2xl p-6 min-h-[400px]">
                      ...
                      <>
                        ...
                        <div className="mt-8 space-y-3">
                          {dest.id === 'office' ? (
                            <>
                              <Button
                                onClick={() => window.open('https://maps.google.com/?q=Narok+Oltalet+Mall+Second+Floor', '_blank')}
                              ...
                              <Button
                                onClick={() => openWhatsApp('our office for physical booking')}
